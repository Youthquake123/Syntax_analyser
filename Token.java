...
public class Token
{
	...
	/** Construct a new token with a given token type

	  @param s The number of  this symbol
	  @param t The original string recognised from the inputting file
	 */
	...
	/** Return a string representation of a symbol type

	  @param i The number of this symbol
